...
import com.lichao.adapter.BleSevicesListAdapter;
import com.lichao.service.BleService;
import com.lichao.utils.Utils;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BleService.ACTION_GATT_CONNECTED.equals(action)) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(DeviceConnectActivity.this, "设备连接成功！",
                                Toast.LENGTH_LONG).show();
                    }
                });
            }
            if (BleService.ACTION_GATT_DISCONNECTED.equals(action)) {
                Toast.makeText(DeviceConnectActivity.this, "设备断开！", Toast.LENGTH_LONG)
                        .show();
    ...
    private void init() {
        ...
        serviceList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View view,
                ...
                Intent servicesIntent = new Intent(DeviceConnectActivity.this,
